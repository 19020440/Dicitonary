...
public class Controllerad  {
	@FXML
	TextField word_target,word_explain,RCM;
	@FXML
...
//			rs.writetoField("database.txt",word_target.getText());
//			rs.writetoField("meaning.txt",word_explain.getText());	
...
//					rs.dictionaryExportToFile(list1, "meaning.txt");
//					rs.dictionaryExportToFile(list,"database.txt");
				}
				else {
